...
import (
	"fmt"
	"github.com/bjsneto/full-cycle-hexagonal-architecture/adapters/cli"
	mock_application "github.com/bjsneto/full-cycle-hexagonal-architecture/application/mocks"
